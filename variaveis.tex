...
\titleen{A system based on public cloud virtual desktop infrastructure for education and research} % Título traduzido para inglês
...
\PalavraChaveD{Conex\~ao Remota}%% Palavra-chave D
...
\KeywordD{Remote Connection}%% Keyword D
