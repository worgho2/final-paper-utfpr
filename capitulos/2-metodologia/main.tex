...
Essa seção apresenta os aspectos pertinentes ao processo de desenvolvimento do sistema, passando pela organização do repositório de código, dos serviços e componentes, dos componentes de infraestrutura e dos testes automatizados.

% A implementação desse trabalho foi organizada em pacotes gerenciados através de uma estrutura de \textit{monorepo}, onde todos os serviços e componentes do sistema são versionados através de um único repositório de código fonte. Nessa estrutura os serviços com mesma base tecnológica compartilham dependencias de mesmo interesse, mas com a possibilidade de utilização de dependências específicas para cada serviço.

\subsection{Estrutura do repositório de código}
\label{subsec:estruturaDoRepositorioDeCodigo}
