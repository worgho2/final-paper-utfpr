...
O processo de modelagem do sistema foi dividido nas seguintes etapas: levantamento de requisitos, conceitos de projeto, projeto de arquitura. \citep{pressman2016}
...
\label{tab:requisitosFuncionaisDoSistema}
\begin{tabularx}{\textwidth}{l X}
\toprule
\textbf{Identificador} & \textbf{Descrição} \\ \midrule
...
\label{tab:requisitosNaoFuncionaisDoSistema}
\begin{tabularx}{\textwidth}{l X}
\toprule
\textbf{Identificador} & \textbf{Descrição} \\ \midrule
...
\subsection{Conceitos de Projeto}
\label{subsec:conceitosDeProjeto}

arquitetura hexagonal, inversão de dependencia, clean architecture, modularidade
