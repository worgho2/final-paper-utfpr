...
\include{./PreTexto/entradas-siglas.tex}%% Entradas da lista de abreviaturas e siglas - Comente para remover este item
\include{./PosTexto/entradas-glossario.tex}%% Entradas do glossário - Comente para remover este item
...
%% Dedicatória
\include{./PreTexto/dedicatoria.tex}%% Comente para remover este item
...
%% Resumo
\include{./PreTexto/resumo.tex}%% Comente para remover este item

%% Abstract
\include{./PreTexto/abstract.tex}%% Comente para remover este item
...
% \part{Introdução}
\include{./capitulos/0-introducao/main.tex}
\include{./capitulos/1-revisao-da-literatura/main.tex}
\include{./capitulos/2-metodologia/main.tex}
\include{./capitulos/3-resultados/main.tex}
% \part{Conclusão}
\include{./capitulos/4-conclusao/main.tex}
...
%   %% Capítulo de exemplo
\include{./PosTexto/apendicea.tex}%% Apêndice - Comente para remover este item
\include{./PosTexto/apendiceb.tex}%% Apêndice - Comente para remover este item
