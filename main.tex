...
%% Resumo
\include{./PreTexto/01-resumo}%% Comente para remover este item

%% Abstract
\include{./PreTexto/02-abstract}%% Comente para remover este item
...
\include{./capitulos/1-referencial-teorico/main.tex}
\include{./capitulos/2-materiais-e-metodos/main.tex}
